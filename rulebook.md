...
|---|---|---|
| `missing_title` done| `Title 1` empty, indexable 200 page | High |
...
| `server_error` done | `Status Code` in 500–599 | High |
| `redirect`  done| `Status Code` in 300–399 | Medium |
...
| `orphan_page` done | `Inlinks` = 0 on an indexable 200 page | Medium |
